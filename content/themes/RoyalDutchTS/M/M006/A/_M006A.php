      ...
      <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12">
        <div class="M006A_slider">
            ...
            <ul class="M006A_slides">
              ...
              ?>
              <li class="M006A_slide" style="background: #fafafa url('<?php  echo $aboutImg['url']; ?>') no-repeat; background-position: center center; height:100%; width:100%;" title="<?php echo $aboutImg['alt']; ?>">
              </li>
